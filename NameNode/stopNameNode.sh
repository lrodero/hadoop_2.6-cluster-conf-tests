...
export HADOOP_PID_DIR=/home/lrodero/Software/repositories/lrodero/hadoop_2.6-cluster-conf-tests/NameNode/pid
export HADOOP_CONF_DIR=/home/lrodero/Software/repositories/lrodero/hadoop_2.6-cluster-conf-tests/NameNode/etc/hadoop
export HADOOP_IDENT_STRING=SmallLocalCluster
/bin/bash hadoop-daemon.sh --script hdfs stop namenode
